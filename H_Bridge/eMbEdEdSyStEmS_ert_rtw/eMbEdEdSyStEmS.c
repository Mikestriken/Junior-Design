...
DW_eMbEdEdSyStEmS_T eMbEdEdSyStEmS_DW;
...
void eMbEdEdSyStEmS_step(void)
{
  ...
  /* Sin: '<Root>/Sine Wave' */
  rtb_Gain = sin(eMbEdEdSyStEmS_P.SineWave_Freq * eMbEdEdSyStEmS_M->Timing.t[0]
                 + eMbEdEdSyStEmS_P.SineWave_Phase) *
    eMbEdEdSyStEmS_P.SineWave_Amp + eMbEdEdSyStEmS_P.SineWave_Bias;
   ...
   */
  eMbEdEdSyStEmS_B.Sum = eMbEdEdSyStEmS_P.Constant4_Value *
    eMbEdEdSyStEmS_P.Constant2_Value * rtb_Gain +
    eMbEdEdSyStEmS_P.Constant3_Value;

  /* Gain: '<Root>/Gain' */
  rtb_Gain = eMbEdEdSyStEmS_P.Gain_Gain * eMbEdEdSyStEmS_B.Sum;

  /* S-Function (c2802xpwm): '<Root>/ePWM 1' */
  ...
  {
    EPwm1Regs.CMPB.bit.CMPB = (uint16_T)(rtb_Gain);
  }

  /* S-Function (c2802xpwm): '<Root>/ePWM 2' */

  /*-- Update CMPA value for ePWM2 --*/
  {
    EPwm2Regs.CMPA.bit.CMPA = (uint16_T)(rtb_Gain);
  }

  /*-- Update CMPB value for ePWM2 --*/
  {
    EPwm2Regs.CMPB.bit.CMPB = (uint16_T)(rtb_Gain);
  }

  /* S-Function (c280xgpio_do): '<Root>/D10 Blue' */
  {
    if (0U) {
  ...
  /* S-Function (c280xgpio_do): '<Root>/D9 Red' */
  {
    if (0U) {
  ...
  eMbEdEdSyStEmS_B.startTime = 0.0;

  {                                    /* Sample time: [0.0s, 0.0s] */
    extmodeErrorCode_T errorCode = EXTMODE_SUCCESS;
    extmodeSimulationTime_T currentTime = (extmodeSimulationTime_T)
      (((eMbEdEdSyStEmS_M->Timing.clockTick0+
         eMbEdEdSyStEmS_M->Timing.clockTickH0* 4294967296.0) * 1) + 0)
      ;
  ...
  {                                    /* Sample time: [1.0E-6s, 0.0s] */
    extmodeErrorCode_T errorCode = EXTMODE_SUCCESS;
    extmodeSimulationTime_T currentTime = (extmodeSimulationTime_T)
      (((eMbEdEdSyStEmS_M->Timing.clockTick1+
         eMbEdEdSyStEmS_M->Timing.clockTickH1* 4294967296.0) * 1) + 0)
      ;
   ...
   */
  if (!(++eMbEdEdSyStEmS_M->Timing.clockTick0)) {
    ++eMbEdEdSyStEmS_M->Timing.clockTickH0;
  }

  eMbEdEdSyStEmS_M->Timing.t[0] = eMbEdEdSyStEmS_M->Timing.clockTick0 *
    eMbEdEdSyStEmS_M->Timing.stepSize0 + eMbEdEdSyStEmS_M->Timing.clockTickH0 *
    eMbEdEdSyStEmS_M->Timing.stepSize0 * 4294967296.0;

  {
     ...
     */
    eMbEdEdSyStEmS_M->Timing.clockTick1++;
    if (!eMbEdEdSyStEmS_M->Timing.clockTick1) {
      eMbEdEdSyStEmS_M->Timing.clockTickH1++;
    }
  }
}
...
void eMbEdEdSyStEmS_initialize(void)
{
  ...
  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&eMbEdEdSyStEmS_M->solverInfo,
                          &eMbEdEdSyStEmS_M->Timing.simTimeStep);
    rtsiSetTPtr(&eMbEdEdSyStEmS_M->solverInfo, &rtmGetTPtr(eMbEdEdSyStEmS_M));
    rtsiSetStepSizePtr(&eMbEdEdSyStEmS_M->solverInfo,
                       &eMbEdEdSyStEmS_M->Timing.stepSize0);
    rtsiSetErrorStatusPtr(&eMbEdEdSyStEmS_M->solverInfo, (&rtmGetErrorStatus
      (eMbEdEdSyStEmS_M)));
    rtsiSetRTModelPtr(&eMbEdEdSyStEmS_M->solverInfo, eMbEdEdSyStEmS_M);
  }

  rtsiSetSimTimeStep(&eMbEdEdSyStEmS_M->solverInfo, MAJOR_TIME_STEP);
  rtsiSetSolverName(&eMbEdEdSyStEmS_M->solverInfo,"FixedStepDiscrete");
  rtmSetTPtr(eMbEdEdSyStEmS_M, &eMbEdEdSyStEmS_M->Timing.tArray[0]);
  rtmSetTFinal(eMbEdEdSyStEmS_M, 1.0);
  eMbEdEdSyStEmS_M->Timing.stepSize0 = 1.0E-6;

  /* External mode info */
  eMbEdEdSyStEmS_M->Sizes.checksums[0] = (911128225U);
  eMbEdEdSyStEmS_M->Sizes.checksums[1] = (2202494682U);
  eMbEdEdSyStEmS_M->Sizes.checksums[2] = (3828867055U);
  eMbEdEdSyStEmS_M->Sizes.checksums[3] = (4203147097U);
  ...
  /* states (dwork) */
  (void) memset((void *)&eMbEdEdSyStEmS_DW, 0,
                sizeof(DW_eMbEdEdSyStEmS_T));

  /* Start for S-Function (c2802xpwm): '<Root>/ePWM 1' */
  ...
  /*** Initialize ePWM1 modules ***/
  {
     ...
     */
    EPwm1Regs.ETSEL.all = (EPwm1Regs.ETSEL.all & ~0xFF7FU) | 0x1109U;
  ...
  /* Start for S-Function (c2802xpwm): '<Root>/ePWM 2' */
  ...
  /* Start for S-Function (c280xgpio_do): '<Root>/D10 Blue' */
  EALLOW;
  GpioCtrlRegs.GPAMUX2.all &= 0x3FFFFFFFU;
  GpioCtrlRegs.GPADIR.all |= 0x80000000U;
  EDIS;

  /* Start for S-Function (c280xgpio_do): '<Root>/D9 Red' */
  EALLOW;
