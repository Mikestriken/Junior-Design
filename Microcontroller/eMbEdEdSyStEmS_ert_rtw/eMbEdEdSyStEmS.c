...
void eMbEdEdSyStEmS_step(void)
{
  ...
  /* Clock: '<S1>/Clock' */
  rtb_Gain = eMbEdEdSyStEmS_M->Timing.t[0];
   ...
   *  Sum: '<S1>/Sum'
   */
  rtb_Gain = (eMbEdEdSyStEmS_P.Constant4_Value *
              eMbEdEdSyStEmS_P.Constant2_Value *
              (eMbEdEdSyStEmS_P.Constant_Value * look1_binlxpw(fmod(rtb_Gain,
    eMbEdEdSyStEmS_P.Constant_Value_i), eMbEdEdSyStEmS_P.LookUpTable1_bp01Data,
    eMbEdEdSyStEmS_P.RepeatingSequence_rep_seq_y, 1UL)) +
              eMbEdEdSyStEmS_P.Constant3_Value) * eMbEdEdSyStEmS_P.Gain_Gain;
  ...
  {                                    /* Sample time: [0.0s, 0.0s] */
    ...
    extmodeSimulationTime_T currentTime = (extmodeSimulationTime_T)
      ((eMbEdEdSyStEmS_M->Timing.clockTick0 * 1) + 0)
      ;
  ...
  {                                    /* Sample time: [0.2s, 0.0s] */
    extmodeErrorCode_T errorCode = EXTMODE_SUCCESS;
    extmodeSimulationTime_T currentTime = (extmodeSimulationTime_T)
      ((eMbEdEdSyStEmS_M->Timing.clockTick1 * 1) + 0)
      ;
...
void eMbEdEdSyStEmS_initialize(void)
{
  ...
  /* External mode info */
  eMbEdEdSyStEmS_M->Sizes.checksums[0] = (3691027105U);
  eMbEdEdSyStEmS_M->Sizes.checksums[1] = (2608144854U);
  eMbEdEdSyStEmS_M->Sizes.checksums[2] = (246084033U);
  eMbEdEdSyStEmS_M->Sizes.checksums[3] = (2533226172U);
