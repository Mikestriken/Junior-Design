###########################################################################
## Makefile generated for component 'stolen'. 
## 
## Makefile     : stolen.mk
## Generated on : Thu Dec 08 16:55:28 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/stolen.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/stolen.out
...
DEFINES_STANDARD = -DMODEL=stolen -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/stolen_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/stolen_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/stolen_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/stolen_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/stolen_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/stolen_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/stolen_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/stolen_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


stolen.obj : $(START_DIR)/stolen_ert_rtw/stolen.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


stolen_data.obj : $(START_DIR)/stolen_ert_rtw/stolen_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
